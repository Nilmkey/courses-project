      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl xl:text-8xl font-black text-slate-900 dark:text-white mb-6 sm:mb-8 tracking-tighter leading-[1.05]">
          <span className="block">
            Построй свой
            <br className="hidden md:block" /> путь в IT{" "}
        ...
        <div
          className={`flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center transition-opacity duration-700 ${subtitle.isComplete ? "opacity-100" : "opacity-0"}`}
        >
          {isAuthenticated ? (
