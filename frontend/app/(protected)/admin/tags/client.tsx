...
export default function AdminTagsPage() {
  ...
  const handleUpdate = async (id: string) => {
    ...
    try {
      ...
      const message =
        err instanceof Error ? err.message : "Ошибка при обновлении тега";
      toast.error(message);
    }
  };
    ...
    toast.confirm(
      ...
      async () => {
        try {
          ...
          const message =
            err instanceof Error ? err.message : "Ошибка при удалении тега";
          toast.error(message);
        }
      },
    );
              ...
              <CardContent className="flex flex-col items-center justify-center py-6 text-center">
                ...
                <p className="text-sm text-slate-500 dark:text-slate-400 font-medium">
                  {searchQuery
                    ...
                    : "Создайте первый тег с помощью формы слева"}
                </p>
              </CardContent>
            </Card>
          ) : (
