    ...
    <div className="h-full flex flex-col pt-4 sm:pt-6 pb-3 sm:pb-4">
      ...
      <div className="flex-1 overflow-y-auto px-4 py-4 space-y-2 custom-scrollbar">
        {sections.map((section) => (
          <div key={section._id} className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-2xl shadow-sm overflow-hidden transition-all hover:border-indigo-100 dark:hover:border-indigo-900/50">
