        ...
        <div className="flex flex-col gap-4 min-w-[280px] p-1">
          <div className="flex flex-col gap-1">
            ...
            <p
              ...
              style={{ color: mounted && (resolvedTheme === "dark" || theme === "dark") ? "#94a3b8" : "#64748b" }}
            >
              {title}
            </p>
          </div>
          ...
          <div
            ...
            style={{ borderTop: `1px solid ${mounted && (resolvedTheme === "dark" || theme === "dark") ? "#1e293b" : "#e2e8f0"}` }}
          >
            <button
              onClick={() => toast.dismiss(t.id)}
              className="px-4 py-2 text-xs font-bold uppercase transition-colors"
              style={{
                color: mounted && (resolvedTheme === "dark" || theme === "dark") ? "#94a3b8" : "#64748b",
              }}
              onMouseEnter={(e) =>
