      ...
      <div className="max-w-4xl mx-auto w-full">
        <div className="flex items-center justify-between mb-3 sm:mb-4">
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <div className="flex items-center gap-1 sm:gap-2 bg-slate-100/50 dark:bg-slate-800/50 p-0.5 sm:p-1 rounded-xl glass-panel">
              <button
                onClick={navigateToPreviousBlock}
                className="w-9 h-9 sm:w-10 sm:h-10 flex items-center justify-center rounded-lg hover:bg-white dark:hover:bg-slate-700 hover:shadow-sm text-slate-600 dark:text-slate-400 transition-all disabled:opacity-30 disabled:hover:shadow-none disabled:hover:bg-transparent"
          ...
          <h1 className="text-sm sm:text-base md:text-lg font-black text-slate-900 dark:text-white truncate max-w-[120px] sm:max-w-[150px] md:max-w-lg tracking-tight px-2 sm:px-4 text-center">
            {course.title}
          </h1>

          <div className="w-[72px] sm:w-[88px] md:w-[96px]" />
        </div>
        ...
        {currentBlock && (
          <div className="mt-3 sm:mt-4 flex flex-wrap items-center justify-center gap-1.5 sm:gap-2 text-[10px] sm:text-xs md:text-sm font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest text-center">
            ...
            <span className="text-indigo-500 dark:text-indigo-400 mx-1 sm:mx-2">/</span>
            <span className="truncate max-w-[120px] sm:max-w-[150px] md:max-w-sm">
