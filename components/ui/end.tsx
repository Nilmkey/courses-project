    ...
    <section className="container mx-auto px-4 py-24 object-center relative z-10">
      <div className="relative bg-gradient-to-br from-indigo-600 via-blue-600 to-indigo-800 rounded-[3rem] p-12 md:p-24 overflow-hidden shadow-2xl shadow-indigo-500/30">
        <div className="absolute top-0 right-0 w-full h-full pointer-events-none">
          ...
          <div className="absolute inset-0 opacity-[0.1]" style={{ backgroundImage: `url("data:image/svg+xml,%3Csvg width='20' height='20' viewBox='0 0 20 20' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='%23ffffff' fill-opacity='1' fill-rule='evenodd'%3E%3Ccircle cx='3' cy='3' r='1.5'/%3E%3Ccircle cx='13' cy='13' r='1.5'/%3E%3C/g%3E%3C/svg%3E")` }} />
        </div>
        ...
        <div className="relative z-10 max-w-3xl text-center mx-auto text-white flex flex-col items-center">
          ...
          <h3 className="text-4xl md:text-6xl font-black mb-8 leading-tight tracking-tight">
            Готов написать свой <br className="hidden md:block" /> первый <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-300 to-blue-300">Hello World</span>?
          </h3>
